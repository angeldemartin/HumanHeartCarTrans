...
levels(seuratFb)
VlnPlot(object=seuratFb, features = "ENSG00000125378.BMP4", cols = coldiseaseCond) + theme(legend.position = "none")
```
...
VlnPlot(object=seuratPerivFb, features = "ENSG00000112175.BMP5", cols = coldiseaseCond) + theme(legend.position = "none")
```

## Scatter plot BMP4 in Fb vs Tcells
```{r scatter BMP4vsTcells}
...
p <- ggscatter(dat_all, x="percent", y="ENSG00000125378.BMP4",
  ...
  stat_cor(p.accuracy = 0.001, r.accuracy = 0.001, label.x = 0, label.y = -0.2)  # Add correlation stats
p

```

```{r scatter BMP4vsTcells individual diseaecond}
## plot indiviual diseasecond
...
p <- ggscatter(dat_HH, x="percent", y="ENSG00000125378.BMP4",
  ...
  geom_point(aes(color = diseasecond), alpha = 0.5, size = 3) +  # Customize point size and transparency
  geom_smooth(method = "lm", se = TRUE, color = "black") + # Add regression line with confidence interval
  stat_cor(p.accuracy = 0.001, r.accuracy = 0.001, label.x = 0.020, label.y = 1)  # Add correlation stats
p
...
p <- ggscatter(dat_expl, x="percent", y="ENSG00000125378.BMP4",
  ...
  geom_point(aes(color = diseasecond), alpha = 0.5, size = 3) +  # Customize point size and transparency
  geom_smooth(method = "lm", se = TRUE, color = "black") + # Add regression line with confidence interval
  stat_cor(p.accuracy = 0.001, r.accuracy = 0.001, label.x = 0.05, label.y = 1.5)  # Add correlation stats
p
...
p <- ggscatter(dat_v1to3, x="percent", y="ENSG00000125378.BMP4",
  ...
  geom_point(aes(color = diseasecond), alpha = 0.5, size = 3) +  # Customize point size and transparency
  geom_smooth(method = "lm", se = TRUE, color = "black") + # Add regression line with confidence interval
  stat_cor(p.accuracy = 0.001, r.accuracy = 0.001, label.x = 0.3, label.y = 0.75)  # Add correlation stats
p
...
p <- ggscatter(dat_v1, x="percent", y="ENSG00000125378.BMP4",
  ...
  geom_point(aes(color = diseasecond), alpha = 0.5, size = 3) +  # Customize point size and transparency
  geom_smooth(method = "lm", se = TRUE, color = "black") + # Add regression line with confidence interval
  stat_cor(p.accuracy = 0.001, r.accuracy = 0.001, label.x = 0.3, label.y = 0.8)  # Add correlation stats
p
...
p <- ggscatter(dat_v2, x="percent", y="ENSG00000125378.BMP4",
  ...
  geom_point(aes(color = diseasecond), alpha = 0.5, size = 3) +  # Customize point size and transparency
  geom_smooth(method = "lm", se = TRUE, color = "black") + # Add regression line with confidence interval
  stat_cor(p.accuracy = 0.001, r.accuracy = 0.001, label.x = 0.1, label.y = 0.1)  # Add correlation stats
p
...
p <- ggscatter(dat_v3, x="percent", y="ENSG00000125378.BMP4",
  ...
  geom_point(aes(color = diseasecond), alpha = 0.5, size = 3) +  # Customize point size and transparency
  geom_smooth(method = "lm", se = TRUE, color = "black") + # Add regression line with confidence interval
  stat_cor(p.accuracy = 0.001, r.accuracy = 0.001, label.x = 0.1, label.y = 0.7)  # Add correlation stats
p
```
